...
export default function WomanAllergies() {
  ...
  // On "Continue", save selected allergies (as CSV string)
    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-tr from-teal-100 via-white to-teal-200">
      ...
      <main className="flex-1 flex flex-col items-center pt-32 px-2">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-gray-600 text-base text-center">You can select more than one option.</p>
        </div>
        ...
        {/* Continue button if user selected at least one allergy (except No allergies/Other) */}
        {selected.length > 0 && (
          <button
